          ...
          <Reveal key={p.name} from={i % 2 === 0 ? "left" : "right"} delay={i * 120} className="h-full">
            {p.compact ? (
              <div className="flex flex-col gap-5 sm:gap-6 h-full">
                <article className="glass-card hover-glow rounded-2xl p-6 sm:p-7 group hover:translate-y-[-2px] transition-transform duration-500 flex-1 basis-0 min-h-0 flex flex-col">
                ...
                <Link
                  to="/work"
                  className="ribbon-card glass-card hover-glow rounded-2xl p-6 sm:p-7 flex flex-col items-center justify-center text-center group hover:translate-y-[-2px] transition-transform duration-500 flex-1 basis-0 min-h-[120px] sm:min-h-0 relative overflow-hidden"
                >
