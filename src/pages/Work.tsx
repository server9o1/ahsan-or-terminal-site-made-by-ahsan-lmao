...
const works = [
  {
    ...
    badge: "50+",
    blurb:
      "Anime Music Videos showcasing advanced editing techniques and creative storytelling",
  },
  {
    icon: ImageIcon,
    ...
    badge: "Multiple",
    blurb:
      "Professional photo manipulation and enhancement for diverse client requirements",
  },
  {
    icon: FileText,
    ...
    badge: "1 Publication",
    blurb:
      "Comprehensive educational resource on Blood Circulation created in Microsoft Word",
  },
  {
    icon: Table,
    ...
    badge: "Ongoing",
    blurb: "Professional Excel sheets for financial tracking and analysis",
  },
  {
    icon: Presentation,
    ...
    badge: "Numerous",
    blurb: "Engaging PowerPoint presentations for educational purposes",
  },
  {
    icon: Palette,
    title: "Digital Arts",
    ...
    badge: "Various",
    blurb:
      "Creative digital artwork and graphic design projects showcasing artistic skills",
  },
];
                ...
                <article className="glass-card hover-glow rounded-2xl p-6 h-full flex flex-col group hover:translate-y-[-2px] transition-transform duration-500">
                  <div className="flex items-start justify-between">
                    <div
                      ...
                      style={{
                        background:
                          "linear-gradient(135deg, oklch(0.70 0.20 285), oklch(0.65 0.22 245))",
                      }}
                    >
                  ...
                  <h3 className="mt-6 text-xl font-bold font-sans">
                    {w.title}
                  </h3>
